...
//  for (int i = 0; i<16; ++i) {
//    char currentTerrain = terrain[i];
//    char nextTerrain = (i == 15) ? newTerrain : terrain[i+1];
//    switch (currentTerrain) {
//      case emptyterrainbyte:
//        terrain[i] = (nextTerrain == terrainbyte) ? leftterrainbyte : emptyterrainbyte;
//        break;
//      case terrainbyte:
//        terrain[i] = (nextTerrain == emptyterrainbyte) ? rightterrainbyte : terrainbyte;
//        break;
//      case leftterrainbyte:
//        terrain[i] = terrainbyte;
//        break;
//      case rightterrainbyte:
//        terrain[i] = emptyterrainbyte;
//        break;
//    }
//  }
//} code from website
